     ...
     <div class="inside_member">
        ...
        <div class="member_rightc">
          <div class="xiugaimima member_boxsty">
		    ...
		    <table width="337" height="141" border="0" cellpadding="0" cellspacing="0" class="xgmm_table">
 				   <tr>
 				   ...
 				   <tr>
 				     <td>确认密码：</td>
 				     <td><input type="text" name="textfield4" id="textfield4" class="input-text-2" /></td>
		      </tr>
 				   <tr>
 				     <td>&nbsp;</td>
 				     <td> <input type="submit" name="button2" id="button2" value="保存" class="tj_buts" /></td>
		      </tr>
		    </table>
            </form>
          </div>
