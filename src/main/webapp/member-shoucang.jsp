     ...
     <div class="inside_member">
        ...
        <div class="member_rightc">
          <div class="dingdan member_boxsty">
       		<p class="stitle"><strong>我的收藏</strong></p>
       		<table width="779" height="89" border="0" cellpadding="0" cellspacing="0" class="shoucang_table">
             		  <tr>
             		    <td width="135"><a href="#" target="_blank"><img src="images/simg_17.jpg" width="171" height="214" /></a></td>
             		    <td width="555">
                        	<h3><a href="#">庾澄庆我要给你世界巡回演唱会北京站</a></h3>
                        	<p>类型：演唱会状态：预定</p>
                            <p>时间：2013.09.14场馆：万事达中心（原五棵松体育馆）</p>
                            <p>票价：280,380,480,580,980</p>
                        </td>
             		    <td width="89"><a href="#" target="_blank" title="立即购买">立即购买</a></td>
           		    </tr>
