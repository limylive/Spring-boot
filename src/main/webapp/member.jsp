     ...
     <div class="inside_member">
        ...
        <div class="member_rightc">
        	 <div class="welco_box">
             	<div class="wel_left">
                	<div class="tx">
                    	<a href="#"><img src="images/simg_tx.jpg" width="90" height="90" /></a>
                    </div>
                    <p><a href="#">编辑个人信息</a></p>
                </div>
                ...
                <div class="wel_right">
                	<p>您好，<strong>波洛克罗星球人</strong>！</p>
                	<p>钱　　包：0 元</p>
                    <p>积　　分：0</p>
                    <p class="time">上次登录：2012年05月20日 17:49:39</p>
                    <div class="user-msg"><a href="#">待支付订单（0）</a><a href="#">缺货登记到货（0）</a><a href="#">未读站内消息（1）</a></div>
                </div>
          ...
          <div class="dingdan member_boxsty">
       		<p class="stitle"><strong>最新订单</strong></p>
       		<table width="779" height="89" border="0" cellpadding="0" cellspacing="0" class="dingdan_table">
             		  <tr class="title">
             		    <td width="115">订单号</td>
             		    <td width="154">成功时间</td>
             		    <td width="154">订购数量</td>
             		    <td width="221">订单总金额</td>
             		    <td width="128">交易状态</td>
           		    </tr>
             		  <tr>
             		    <td>12345684646</td>
             		    <td>2013-07-01</td>
