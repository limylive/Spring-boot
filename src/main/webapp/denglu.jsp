     ...
     <div id="login_mainbox">
        ...
        <div class="right">
        	<div class="cont">
                ...
                <p>账　号：<input type="text" name="uname" id="uname" class="input_sty" /></p>
                <br /> 
                  <label id="unamemsg" style="color: red">
                  &nbsp;  </label>
                <p>密　码：<input type="password" name="upwd" id="upwd" class="input_sty" /></p>	
                  <br />
               <label id="upwdmsg" style="color: red">
                  &nbsp; </label>
                <p class="mdl">
                ...
                <p class="dl">
                  <label>
                    <input type="submit" name="button2" id="button2" value="登 陆" />
                  </label>
                </p>
                </form>
                <p class="zc"><a href="zhuce.jsp"><img src="images/icon_zc.gif" width="151" height="27" /></a></p>
          </div>
